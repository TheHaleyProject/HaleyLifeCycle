...
namespace Haley.Internal {
    internal class QRY_EVENT {
        public const string INSERT = $@"INSERT IGNORE INTO events (id, display_name, def_version) VALUES ({ID}, {DISPLAY_NAME}, {DEF_VERSION}); SELECT id FROM events WHERE display_name = {DISPLAY_NAME} AND def_version = {DEF_VERSION} LIMIT 1;";
